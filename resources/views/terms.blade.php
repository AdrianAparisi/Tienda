...
@section('main')
    ...
    <section>
        ...
        <p>Esta página web es propiedad y está operado por Reecock. Estos Términos establecen los términos y
            condiciones
        ...
        <article>
            ...
            <p>Reecock hará todo lo posible por complacer a todos sus clientes en la demanda de los productos.</p>
        ...
        <article>
            ...
            <p>Al realizar una compra en Reecock estás aceptando los términos y condiciones y política de privacidad
                de nuestra
                web.</p>
            ...
            <p>Una vez realizado el pago, recibirás por parte de Reecock un correo electrónico, en tu cuenta de
                email asignada a
        ...
        <article>
            ...
            <p>Los envíos se realizan dentro de la UE. El usuario podrá comprobar si su dirección postal está dentro
                de las
                zonas de envío o reparto de Reecock, al momento de incluir sus datos (dirección de envío) en el
                formulario de
                compra. </p>
            ...
            <p>El pedido de compra que corresponde al pedido estará disponible en Reecock, una vez que se confirme
                el pago, que
            ...
            <p>Reecock pedirá a sus clientes que elija el lugar de la entrega, debiendo especificar su domicilio,
                oficina o
        ...
        <article>
            ...
            <p>Solo las pasarelas de pago mencionadas anteriormente tienen acceso a los datos bancarios vinculados a
                estos
                medios de pago, Reecock no tiene acceso a ellos en ningún momento.</p>
        ...
        <article>
            ...
            <p>Las garantías y servicios postventa se regirán por el Real Decreto Legislativo 1/2007 de 16 de
                ...
                cualquier
                devolución debe ponerse en contacto con Reecock a través de correo electrónico Reecock69@gmail.com
                indicando su
            ...
            <p>El consumidor debe informar a Reecock en el plazo de dos meses desde que tuvo conocimiento de la no
                conformidad
