...
@section('title', 'Política y Coockies')
...
@section('main')
    ...
    <section>
        ...
        <p>En Reecock nos comprometemos al 100% en proteger la privacidad y la seguridad de nuestros usuarios y
            clientes.
            Las personas que formamos parte del equipo de Reecock también somos usuarios y clientes de otros sitios
            web, así
        ...
        <article>
            ...
            <p>En Reecock sólo recopilamos y tratamos los datos que tú nos facilitas de forma voluntaria. Y es que
                no tienes por
